...
/** State25's exact approval.requested payload; its approval hash binds the blocked child tool. */
...
/** State25's exact auto_review.requested payload; no reviewer or model handle crosses SPI. */
...
/** State25's approval payload for a blocked task child; no live owner crosses SPI. */
...
/** State25's auto-review request for a blocked task child; the reviewer remains outside SPI. */
 ...
 * and the State25 interaction event; task runtime, continuation bytes,
