...
export function generateRuntimeProtocolTypeScript(): string {
  return [
    ...
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'history/list_sessions'; readonly params: { readonly request: { readonly cursor?: { readonly updatedAt: RuntimeProtocolRevision; readonly sessionId: RuntimeProtocolIdentifier }; readonly limit: RuntimeProtocolRevision; readonly query?: string } } }",
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'history/list_events'; readonly params: { readonly request: { readonly sessionId: RuntimeProtocolIdentifier; readonly afterSequence?: RuntimeProtocolRevision; readonly beforeSequence?: RuntimeProtocolRevision; readonly direction: 'forward' | 'backward'; readonly limit: RuntimeProtocolRevision; readonly eventTypes?: readonly string[] } } }",
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'history/load_session'; readonly params: { readonly sessionId: RuntimeProtocolIdentifier } }",
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'app/workspace_trust/query'; readonly params: { readonly request: Readonly<Record<string, unknown>> } }",
