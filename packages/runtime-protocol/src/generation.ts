...
export function generateRuntimeProtocolTypeScript(): string {
  return [
    ...
    'export type RuntimeProtocolToolPresentationOwner = {',
    '  readonly subagentId: RuntimeProtocolIdentifier;',
    '  readonly parentToolCallId: RuntimeProtocolIdentifier;',
    '};',
    ...
    '  readonly presentationOwner?: RuntimeProtocolToolPresentationOwner;',
    ...
    '  readonly summary: string;',
    '};',
    'export type RuntimeProtocolToolFailedEvent = {',
    ...
    '  readonly summary: string;',
    '};',
    'export type RuntimeProtocolToolRejectedEvent = {',
    ...
    '  readonly summary: string;',
    '};',
    'export type RuntimeProtocolToolCancelledEvent = {',
    ...
    '  readonly summary?: string;',
    '};',
    'export type RuntimeProtocolInteractionOwner =',
    "  | { readonly kind: 'root_tool'; readonly toolCallId: RuntimeProtocolIdentifier }",
    "  | { readonly kind: 'subagent_tool'; readonly toolCallId: RuntimeProtocolIdentifier; readonly subagentId: RuntimeProtocolIdentifier; readonly parentToolCallId: RuntimeProtocolIdentifier };",
    'export type RuntimeProtocolSubagentStartedEvent = {',
    ...
    '  readonly parentToolCallId?: RuntimeProtocolIdentifier;',
    '  readonly concurrencyGroupId?: RuntimeProtocolIdentifier;',
    '};',
    'export type RuntimeProtocolSubagentPhaseEvent = {',
    "  readonly type: 'subagent.phase';",
    '  readonly subagentId: RuntimeProtocolIdentifier;',
    '  readonly parentToolCallId: RuntimeProtocolIdentifier;',
    "  readonly status: 'running' | 'suspended';",
    "  readonly approvalState?: 'queued_auto_review' | 'auto_reviewing' | 'queued_user_approval' | 'awaiting_user' | 'authorized_queued';",
    '  readonly interactionId?: RuntimeProtocolIdentifier;',
    '  readonly reviewId?: RuntimeProtocolIdentifier;',
    '};',
    'export type RuntimeProtocolSubagentStepEvent = {',
    "  readonly type: 'subagent.step';",
    '  readonly subagentId: RuntimeProtocolIdentifier;',
    '  readonly stepId: RuntimeProtocolIdentifier;',
    '  readonly toolCallId: RuntimeProtocolIdentifier;',
    ...
    '  readonly summary?: string;',
    '};',
    'export type RuntimeProtocolSubagentReviewEvent = {',
    ...
    '  readonly summary?: string;',
    '};',
    'export type RuntimeProtocolSubagentFailedEvent = {',
    ...
    '  readonly owner: RuntimeProtocolInteractionOwner;',
    ...
    '    readonly question: string;',
    '    readonly allowFreeText: boolean;',
    '    readonly options?: readonly { readonly id: RuntimeProtocolIdentifier; readonly label: string; readonly description?: string }[];',
    '  }[];',
    '};',
    ...
    "  | { readonly schema: 'kite.runtime-command.v1'; readonly commandId: RuntimeProtocolIdentifier; readonly type: 'recover_session'; readonly sessionId: RuntimeProtocolIdentifier; readonly expectedRevision: RuntimeProtocolRevision; readonly expectedAuthorityRevision: RuntimeProtocolRevision }",
    "  | { readonly schema: 'kite.runtime-command.v1'; readonly commandId: RuntimeProtocolIdentifier; readonly type: 'create_session'; readonly workspace?: string; readonly bootstrapSessionId?: RuntimeProtocolIdentifier; readonly model?: { readonly provider: RuntimeProtocolIdentifier; readonly name: string } }",
    ...
    "  | { readonly schema: 'kite.runtime-query.v1'; readonly type: 'get_command_receipt'; readonly sessionId: RuntimeProtocolIdentifier; readonly command: RuntimeProtocolCommand }",
    "  | { readonly schema: 'kite.runtime-query.v1'; readonly type: 'get_session_recovery'; readonly sessionId: RuntimeProtocolIdentifier }",
    ...
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'initialize'; readonly params: { readonly protocolVersion: 2; readonly clientInfo: { readonly name: string; readonly version: string; readonly instanceId: RuntimeProtocolIdentifier } } }",
    ...
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'history/list_sessions'; readonly params: { readonly request: { readonly cursor?: { readonly updatedAt: RuntimeProtocolRevision; readonly sessionId: RuntimeProtocolIdentifier }; readonly limit: RuntimeProtocolRevision; readonly query?: string; readonly workspaceDigest?: string } } }",
    ...
    "  | { readonly jsonrpc: '2.0'; readonly id: string; readonly method: 'history/load_session'; readonly params: { readonly sessionId: RuntimeProtocolIdentifier; readonly page?: { readonly afterSequence?: number; readonly throughSequence?: number } } }",
    ...
    "export type RuntimeProtocolSchema = 'kite.runtime-protocol.v2';",
    '',
  ].join('\n');
}
