...
export function generateRuntimeProtocolTypeScript(): string {
  return [
    ...
    "  | { readonly schema: 'kite.runtime-command.v1'; readonly commandId: RuntimeProtocolIdentifier; readonly type: 'create_session'; readonly bootstrapSessionId?: RuntimeProtocolIdentifier; readonly model?: { readonly provider: RuntimeProtocolIdentifier; readonly name: string } }",
