...
function restore(
  ...
  extra: Partial<
    Pick<Parameters<typeof restoreRuntimeHostState26SessionV1>[0], 'validateRestoredState'>
  > = {},
) {
  return restoreRuntimeHostState26SessionV1({
...
describe('Runtime Host State26 restore', () => {
  test('creates only the exact fresh State26 format when storage is empty', () => {
