...
export type RuntimeHostState26ToolGovernanceFactsV1 = ToolGovernanceFactsV1;
export type RuntimeHostState26ToolGovernanceDecisionV1 = ToolGovernanceDecisionV1;
 ...
 */
export interface RuntimeHostState26ToolGovernanceAuthorizationInputV1<
...
> {
   ...
   */
  readonly sameCommandGrant?: Readonly<RuntimeHostState26SameCommandGrantInputV1>;
}

/** Full projection input; admission is deliberately supplied only at admit. */
export interface RuntimeHostState26ToolGovernanceInputV1<
  TArguments extends RuntimeJsonValueV1 = RuntimeJsonValueV1,
> extends RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments> {
  readonly admission: Readonly<ToolGovernanceAdmissionFactsV1>;
}

export interface RuntimeHostState26SameCommandGrantInputV1 {
...
export type RuntimeHostState26ToolGovernanceFailureCodeV1 =
...
export interface RuntimeHostState26ToolGovernanceFailureV1 {
  readonly code: RuntimeHostState26ToolGovernanceFailureCodeV1;
  /** Bounded, secret-free diagnostic. */
  readonly diagnostic: string;
}

export type RuntimeHostState26ToolGovernanceResultV1<T> =
  | { readonly ok: true; readonly value: Readonly<T> }
  | {
      readonly ok: false;
      readonly failure: Readonly<RuntimeHostState26ToolGovernanceFailureV1>;
    };

export interface RuntimeHostState26ToolGovernancePortV1<
  TArguments extends RuntimeJsonValueV1 = RuntimeJsonValueV1,
> {
  readonly project: (
    input: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments>>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ) => RuntimeHostState26ToolGovernanceResultV1<ToolGovernanceFactsV1>;
  readonly authorize: (
    input: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments>>,
  ) => RuntimeHostState26ToolGovernanceResultV1<ToolGovernanceAuthorizationDecisionV1>;
  readonly admit: (
    input: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments>>,
    authorization: Readonly<ToolGovernanceAuthorizationDecisionV1>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ) => RuntimeHostState26ToolGovernanceResultV1<ToolGovernanceDecisionV1>;
  readonly decide: (
    input: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments>>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ) => RuntimeHostState26ToolGovernanceResultV1<ToolGovernanceDecisionV1>;
 ...
 * consulted here.
 */
export function createRuntimeHostState26ToolGovernanceV1<
  TArguments extends RuntimeJsonValueV1 = RuntimeJsonValueV1,
>(input: {
  readonly verifyClassifiedIdentity: ToolPipelineClassifiedIdentityVerifierV1<TArguments>;
}): RuntimeHostState26ToolGovernancePortV1<TArguments> {
  ...
  const project = (
    governanceInput: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments>>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ): RuntimeHostState26ToolGovernanceResultV1<ToolGovernanceFactsV1> => {
    return projectState26FactsV1(governanceInput, admission, verifyClassifiedIdentity);
  };
...
function projectState26FactsV1<TArguments extends RuntimeJsonValueV1>(
  input: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1<TArguments>>,
  admission: Readonly<ToolGovernanceAdmissionFactsV1>,
...
function invocationFactV1(
  input: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1>,
  invocation: Readonly<ToolPipelineGovernanceProjectionV1['invocation']>,
...
function contextFactsV1(
  context: Readonly<RuntimeHostState26ToolGovernanceAuthorizationInputV1['context']>,
...
function successV1<T>(value: T): RuntimeHostState26ToolGovernanceResultV1<T> {
  return { ok: true, value };
}

function failureV1(
  code: RuntimeHostState26ToolGovernanceFailureCodeV1,
  diagnostic: string,
): RuntimeHostState26ToolGovernanceResultV1<never> {
