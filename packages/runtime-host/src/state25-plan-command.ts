...
import type { RuntimeState } from './state25-initial';

/**
 * Host-owned typed wrapper around the pure State25 plan admission functions.
 *
 ...
 */
export function runtimeHostState25PlanCommandFactsV1(
...
export function runtimeHostState25DecideReadPlanCommandV1(
...
export function runtimeHostState25DecideWritePlanCommandV1(
  facts: PlanCommandStateFactsV1,
...
export function runtimeHostState25DecideUpdatePlanCommandV1(
  facts: PlanCommandStateFactsV1 & {
...
export function runtimeHostState25ProjectPlanCompletionEvidenceV1(
  state: Readonly<RuntimeState>,
...
export function runtimeHostState25PlanCompletionBlockerV1(
  state: Readonly<RuntimeState>,
...
export function runtimeHostState25EmptyPlanCompletionEvidenceV1() {
  return emptyPlanCompletionEvidenceV1();
}

export function runtimeHostState25PlanReviewSiblingCancellationsV1(
  state: Readonly<RuntimeState>,
