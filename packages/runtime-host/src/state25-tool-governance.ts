...
export type RuntimeHostState25ToolGovernanceFactsV1 = ToolGovernanceFactsV1;
export type RuntimeHostState25ToolGovernanceDecisionV1 = ToolGovernanceDecisionV1;
 ...
 */
export interface RuntimeHostState25ToolGovernanceAuthorizationInputV1<
...
> {
   ...
   */
  readonly sameCommandGrant?: Readonly<RuntimeHostState25SameCommandGrantInputV1>;
}

/** Full projection input; admission is deliberately supplied only at admit. */
export interface RuntimeHostState25ToolGovernanceInputV1<
  TArguments extends RuntimeJsonValueV1 = RuntimeJsonValueV1,
> extends RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments> {
  readonly admission: Readonly<ToolGovernanceAdmissionFactsV1>;
}

export interface RuntimeHostState25SameCommandGrantInputV1 {
...
export type RuntimeHostState25ToolGovernanceFailureCodeV1 =
...
export interface RuntimeHostState25ToolGovernanceFailureV1 {
  readonly code: RuntimeHostState25ToolGovernanceFailureCodeV1;
  /** Bounded, secret-free diagnostic. */
  readonly diagnostic: string;
}

export type RuntimeHostState25ToolGovernanceResultV1<T> =
  | { readonly ok: true; readonly value: Readonly<T> }
  | {
      readonly ok: false;
      readonly failure: Readonly<RuntimeHostState25ToolGovernanceFailureV1>;
    };

export interface RuntimeHostState25ToolGovernancePortV1<
  TArguments extends RuntimeJsonValueV1 = RuntimeJsonValueV1,
> {
  readonly project: (
    input: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments>>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ) => RuntimeHostState25ToolGovernanceResultV1<ToolGovernanceFactsV1>;
  readonly authorize: (
    input: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments>>,
  ) => RuntimeHostState25ToolGovernanceResultV1<ToolGovernanceAuthorizationDecisionV1>;
  readonly admit: (
    input: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments>>,
    authorization: Readonly<ToolGovernanceAuthorizationDecisionV1>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ) => RuntimeHostState25ToolGovernanceResultV1<ToolGovernanceDecisionV1>;
  readonly decide: (
    input: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments>>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ) => RuntimeHostState25ToolGovernanceResultV1<ToolGovernanceDecisionV1>;
 ...
 * consulted here.
 */
export function createRuntimeHostState25ToolGovernanceV1<
  TArguments extends RuntimeJsonValueV1 = RuntimeJsonValueV1,
>(input: {
  readonly verifyClassifiedIdentity: ToolPipelineClassifiedIdentityVerifierV1<TArguments>;
}): RuntimeHostState25ToolGovernancePortV1<TArguments> {
  ...
  const project = (
    governanceInput: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments>>,
    admission: Readonly<ToolGovernanceAdmissionFactsV1>,
  ): RuntimeHostState25ToolGovernanceResultV1<ToolGovernanceFactsV1> => {
    return projectState25FactsV1(governanceInput, admission, verifyClassifiedIdentity);
  };
...
function projectState25FactsV1<TArguments extends RuntimeJsonValueV1>(
  input: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1<TArguments>>,
  admission: Readonly<ToolGovernanceAdmissionFactsV1>,
...
function invocationFactV1(
  input: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1>,
  invocation: Readonly<ToolPipelineGovernanceProjectionV1['invocation']>,
...
function contextFactsV1(
  context: Readonly<RuntimeHostState25ToolGovernanceAuthorizationInputV1['context']>,
...
function successV1<T>(value: T): RuntimeHostState25ToolGovernanceResultV1<T> {
  return { ok: true, value };
}

function failureV1(
  code: RuntimeHostState25ToolGovernanceFailureCodeV1,
  diagnostic: string,
): RuntimeHostState25ToolGovernanceResultV1<never> {
