...
export type State25ToolGovernanceInvocationFactV1 = ToolGovernanceInvocationFactV1;
export type State25ToolGovernancePolicyFactV1 = ToolGovernancePolicyFactV1;

export interface RuntimeHostState25VerifiedApprovalBindingInputV1 {
...
export function runtimeHostState25VerifyApprovalBindingDigestV1(input: {
  readonly digest: unknown;
  readonly invocationFact: unknown;
  readonly policyFact: unknown;
}): input is RuntimeHostState25VerifiedApprovalBindingInputV1 {
  const facts = {
...
export function runtimeHostState25CreateApprovalBindingDigestV1(
