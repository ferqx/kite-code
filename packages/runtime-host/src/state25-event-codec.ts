...
/**
 * Host-facing State25 event admission boundary.
 *
 ...
 * the one State25 codec authority.
 */
export function runtimeHostState25AssertCurrentRuntimeEventV1(
  value: unknown,
...
export function runtimeHostState25AdmitCurrentRuntimeEventV1(value: unknown): RuntimeEvent {
  assertCurrentRuntimeEvent(value);
  return value;
}
