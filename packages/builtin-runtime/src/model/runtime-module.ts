...
export const MODEL_PROVIDER_ID_ = 'kite-builtin-runtime-model' as const;
    ...
    Object.fromEntries(
      MODEL_OPERATION_IDS_.map((operationId) => [
        ...
        digestCapabilityBindingValue({
          schema: 'kite.model-operation-capability.current',
          operationId,
...
export const MODEL_EXECUTOR_REVISIONS_: Readonly<Record<ModelOperationId, string>> = Object.freeze(
  Object.fromEntries(
    MODEL_OPERATION_IDS_.map((operationId) => [
      operationId,
      digestCapabilityBindingValue({
        schema: 'kite.model-operation-executor.current',
        operationId,
...
export function createModelRuntimeModule(): RuntimeModule {
  return defineRuntimeModule({
    moduleId: 'kite-builtin-runtime-model',
    providerId: MODEL_PROVIDER_ID_,
    revision: 'model-current',
