...
MCP results retain protocol content blocks and structured content. `_meta` is not persisted in P0. Execution records, artifact handles, recovery and verification are deferred.
