...
迁移不增加 runtime fallback flag。RA-06 已统一切换
schema v26/SQLite Store/`kite-runtime-modularization-v1-2026-08-19`，旧 dispatch shape 不进入新 epoch。
