...
- `apps/kite/test/tool-definitions.test.ts`、`tests/integration/tool-parse-error.test.ts`、
...
`apps/kite/test/tool-definitions.test.ts` 中 `tool contracts (ACI)` describe 块应断言：
