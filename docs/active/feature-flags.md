...
验证：`bun test apps/kite-service/test/config/features.test.ts apps/kite-cli/test/config/features-cli.test.ts`、`bun run test:tui:system prompt-contract-v2-production`。
