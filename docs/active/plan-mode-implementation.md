...
验证：`bun test apps/kite-cli/test/isolated/runtime/agent.integration.test.ts apps/kite-cli/test/runtime/completion-guard.test.ts apps/kite-cli/test/runtime/plan-actions.test.ts tests/isolated/runtime/plan-artifacts.test.ts tests/integration/runtime/plan-persistence.test.ts tests/integration/runtime/plan-state.test.ts tests/integration/runtime-contract/plan-tools.test.ts apps/kite-cli/test/isolated/runtime/task-plan-lifecycle.test.ts packages/builtin-runtime/test/subagent-delegation-contract.test.ts apps/kite-cli/test/subagent-runner.test.ts apps/kite-cli/test/isolated/session-manager.test.ts tests/tui-system/scenarios/plan-review.test.ts tests/tui-system/scenarios/plan-mode-policy.test.ts tests/tui-system/scenarios/session-lifecycle.test.ts`、`bun run typecheck`。
...
`apps/kite-cli/src/bootstrap/runtime/plan-runtime.ts` 是 App 的 Runtime State/SQLite Store persistence/effect bridge，不是第二 schema authority。
