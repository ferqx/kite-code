...
RAV1-05 的 State26/Store5 已由 isolated conformance constructor 固化；RAV1-06 已允许唯一新 Session 使用独立 `.runtime-v5.db` path 与 target epoch。旧 Store4 不修改、不双写、不在线迁移，旧 Session 不读取。
