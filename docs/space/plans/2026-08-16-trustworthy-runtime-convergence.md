...
| PS-02 | next | 新增 `SandboxExecutionProviderV1` 与 Local 实现，迁移 consumer-owned spawn、pure/allocating preparation、single-use prepared plan、crash/dispose recovery；不得降级裸 Shell |
