...
| TP-04 | next | 迁移 typed verification stage、启用 static provider boundary 并继续缩薄 ToolController；先完成 receipt-before-verification 与 legacy parity journey，不得提前进入 Provider seam 或 CUT-01 |
| RP-00/RP-01、Provider seams、CUT-01 | pending | Replay policy/source、Local Filesystem/Sandbox/Subagent Provider 与唯一 production epoch cutover 尚未实施；当前 Model evidence 只有 live source，不得声称 `ModelAttemptOutcomeV1` replay 或新 production epoch 已完成 |
