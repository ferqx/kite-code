...
| RP-01 | next | 实现 `ModelAttemptOutcomeV1` source、live/record/replay mode 与 strict catalog parser；必须保持 admission/ack-before-lookup/dispatch、无 key replay 与零 live fallback |
| RP-02/RP-03、Provider seams、CUT-01 | pending | deterministic pilot/approved replay gate、Local Filesystem/Sandbox/Subagent Provider 与唯一 production epoch cutover 尚未实施；当前 Model evidence 只有 live source，不得声称 replay 或新 production epoch 已完成 |
