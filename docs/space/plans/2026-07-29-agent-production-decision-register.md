...
| 2B.4 | `github:@ferqx` | `dc64d25d67c9e40330676668b5f039872d04269a` | `main` | `in_progress` | 本地 repeated-run/append-only contract 已通过；等待 authenticated live route、route-matched frozen baseline 与完整 8/20 attempt ledger | — | `2026-08-02` |
| 2B.5 | `github:@ferqx` | `dc64d25d67c9e40330676668b5f039872d04269a` | `main` | `in_progress` | 本地 adversarial catalog/concurrency contract 已通过；等待同一 artifact/route 的 formal G0 adversarial run evidence | — | `2026-08-02` |
...
| 4.4 | `github:@ferqx` | `dc64d25d67c9e40330676668b5f039872d04269a` | `main` | `in_progress` | 本地 blind semantic contract 已通过但无 authenticated scoring authority；缺失语义分数时保持 blocked | — | `2026-08-02` |
