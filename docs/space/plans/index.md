...
| [`2026-07-29-agent-production-evaluation.md`](2026-07-29-agent-production-evaluation.md) | active | P0 | Phase 0、2A-F；正式执行依赖 1B/1C 与真实 route | RFC Phase 2B | D-07 closed；2B.1–2B.3/2B.8 completed，2B.4/2B.5 in_progress；真实 route/baseline/attempt/adversarial/human evidence 待满足，不产生 `MS:2B-DONE`；[本地评估基础记录](../execution/completed/2026-08-02-agent-production-evaluation-foundation.md) |
