...
|------|------|--------|------|-----------|----------|
| [2026-08-16-trustworthy-runtime-convergence.md](2026-08-16-trustworthy-runtime-convergence.md) | active | P0 | Runtime Kernel、Context Projection、ToolSpec Registry、当前 execution/verification 边界 | — | MS-01–MS-04、TP-01/TP-02 已完成 Model Gateway、Tool Pipeline 前置 stage、Policy/approval/admission 与 durable Provider readiness；TP-03 intent/dispatch/receipt 为下一任务，Replay、Provider seam 与 CUT-01 尚未实施 |
