...
最后更新：2026-08-27（新增 Kite Local Runtime Service V1 实施方案）
...
|------|------|--------|------|-----------|----------|
| [`2026-08-27-kite-local-runtime-service-v1.md`](2026-08-27-kite-local-runtime-service-v1.md) | draft | P1 | KRSV1 completion、ADR-0053/0129/0139/0140/0141/0142/0143、当前 Runtime/Workspace Trust/Log Query/Release authority | 将 `apps/kite` 拆为 terminal-only `kite-cli` 与唯一 Runtime root `kite-service`，新增 browser-safe App contract 和 Native local-runtime substrate；不实现 Browser/Desktop、通用多 Store 或 OS Service | KLSV1-00～08：ADR/baseline、workspace rename、client contract/native substrate、Runtime Application/App Control、多 Workspace、Service/connector、clean cutover、三平台 release qualification |
