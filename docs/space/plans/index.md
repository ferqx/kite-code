...
|------|------|--------|------|-----------|----------|
| [2026-08-16-trustworthy-runtime-convergence.md](2026-08-16-trustworthy-runtime-convergence.md) | active | P0 | Runtime Kernel、Context Projection、ToolSpec Registry、当前 execution/verification 边界 | — | MS-01–MS-04、TP-01–TP-04 与 RP-00 已完成 Model Gateway、Tool Pipeline 和 Replay governance/privacy；RP-01 response source/catalog 为下一任务，Provider seam 与 CUT-01 尚未实施 |
