...
| [`2026-07-29-agent-production-evaluation.md`](2026-07-29-agent-production-evaluation.md) | active | P0 | Phase 0、2A-F；正式执行依赖 D-07、1B/1C | RFC Phase 2B | 2B.1–2B.9 local synthetic/blocked contract；D-07/MS:1B-DONE 与真实 route/human evidence 待满足，不产生 `MS:2B-DONE` |
