...
| [`2026-06-18-openpx-telemetry-collection.md`](2026-06-18-openpx-telemetry-collection.md) | draft | P2 | `opentelemetry-observability` | — | Kite Code 遥测收集：双通道 opt-in，脱敏工具调用统计，驱动工具契约优化 |
