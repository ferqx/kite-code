...
| [`2026-08-20-kite-runtime-authority-format-v1-implementation.md`](2026-08-20-kite-runtime-authority-format-v1-implementation.md) | active | P0 | RMV1 completion record `e5a64c21`、ADR-0124/0125 | 承接原RMV1中的identity、authority、cross-Host fence和format范围 | [RAV1-00 completed](../execution/completed/2026-08-22-rav1-00-authority-threat-model.md)，implementation SHA `8a2b54cd`；下一阶段 RAV1-01 Project/分层 identity |
