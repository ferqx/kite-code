...
|------|------|--------|------|-----------|----------|
| [`2026-08-29-kite-agent-server-api-v1.md`](2026-08-29-kite-agent-server-api-v1.md) | draft | P1 | Kite Agent Server API V1 RFC、待接受 extension/superseding ADR、KRSV1/KCWW 与当前 Runtime/Store/Controller/Web authority | 在 private Runtime Protocol 之上新增 stable local REST/SSE façade；不开放 remote、Browser mutation、public `/rpc` 或第二 Runtime/Store | KASAPI-00A～05D：ADR/evidence/contract、OpenAPI、read-only façade/API docs、first-class Run、SSE/Interaction、SDK/release qualification；ADR 与 Run/stream evidence Gate 未闭合前不创建 production listener |
