...
最后更新：2026-08-09（归档 Prompt Contract V2，登记 token、真实模型 A/B 与完整 Windows 门禁证据）
...
|------|------|--------|------|-----------|----------|
| [`2026-08-08-prompt-contract-v2.md`](2026-08-08-prompt-contract-v2.md) | archived | P0 | ADR-0090、ToolSpec Registry、Context Projection | [完成记录](../execution/completed/2026-08-09-prompt-contract-v2.md) | 四层 Prompt、项目指令、phase 工具面、可信 MCP 描述、59.85% token 降幅与真实模型 A/B 全部完成 |
