...
最后更新：2026-08-26（接受 Kite Runtime Server V1 修订方案并关闭重叠 LOGWEB carrier 任务）
...
|------|------|--------|------|-----------|----------|
| [`2026-08-26-kite-runtime-server-v1.md`](2026-08-26-kite-runtime-server-v1.md) | active | P1 | ADR-0142、ADR-0053/0129/0137/0138/0140/0141、当前 Runtime/Store/Log Query authority | 接管 LOGWEB-05～09 的 listener/auth/App carrier authority 并关闭旧任务；保留 LOGWEB-00～04 query-only 产出，HTTP/SSE/Web UI 不迁入 | KRSV1-00～10：封闭 Protocol、transport-neutral Server/Client、TUI/CLI InProcess 单路径、原子持久 receipt、stdio 与 development-only WebSocket qualification |
