...
- [`Kite Agent Server API V1 RFC`](2026-08-29-kite-agent-server-api-v1-rfc.md) — `accepted`；ADR-0149 接受在现有私有 Runtime
  ...
  migration。具体[`实施方案`](../space/plans/2026-08-29-kite-agent-server-api-v1.md)已完成KASAPI-01A～02C contract、同源
  ...
  当前进入KASAPI-02D read conformance/fault Gate，未创建第二listener、第二SQLite connection或任何Run mutation。
