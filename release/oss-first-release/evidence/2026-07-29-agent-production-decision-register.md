...
规范来源：
[`ADR-0069 首发终态范围`](../../../docs/adr/0069-first-release-terminal-scope.md)、
[`ADR-0068 单维护者开源首发模型`](../../../docs/adr/0068-single-maintainer-open-source-first-release.md)、
...
- evidence: [Phase 4 计划](2026-07-29-agent-production-compaction-qualification.md)；
  [ADR-0057](../../../docs/adr/0057-compaction-release-qualification.md)
- approvedAt: `null`
...
- evidence: [Phase 1A 计划](2026-07-29-agent-production-local-data-privacy.md)；
  [ADR-0056](../../../docs/adr/0056-metadata-first-data-boundaries.md)
...
- evidence: [Phase 3 计划](2026-07-29-agent-production-observability-operations.md)；
  [ADR-0056](../../../docs/adr/0056-metadata-first-data-boundaries.md)；
  [ADR-0063](../../../docs/adr/0063-no-content-observability-and-single-maintainer-operations.md)；
...
- evidence: [Phase 1B 计划](2026-07-29-agent-production-execution-isolation.md)；
  ...
  [ADR-0053](../../../docs/adr/0053-local-single-user-first-topology.md)；
  [ADR-0061](../../../docs/adr/0061-production-platform-capability-admission.md)；
...
release gate fail closed。依据：[ADR-0065](../../../docs/adr/0065-cross-platform-distribution-and-capability-admission.md)
...
- evidence: [Phase 6 计划](2026-07-29-agent-production-ga.md)；
  [ADR-0051](../../../docs/adr/0051-release-profile-monotonic-composition.md)
- approvedAt: `null`
...
- evidence: [Phase 2A 计划](2026-07-29-agent-production-release-control.md)；
  [ADR-0052](../../../docs/adr/0052-release-evidence-and-behavior-identity.md)；
  [ADR-0059](../../../docs/adr/0059-optional-disable-only-signed-rollout.md)；
  [ADR-0062](../../../docs/adr/0062-keyless-release-signing-and-github-hosting.md)；
  [ADR-0067](../../../docs/adr/0067-single-maintainer-candidate-security-review.md)；用户于 2026-08-02
...
- evidence: [Phase 2B 计划](2026-07-29-agent-production-evaluation.md)；
  [ADR-0058](../../../docs/adr/0058-agent-task-product-acceptance.md)；用户于 2026-08-02 批准单维护者优先
...
- evidence: [Phase 1B 计划](2026-07-29-agent-production-execution-isolation.md)；
  [ADR-0054](../../../docs/adr/0054-production-execution-isolation.md)
- approvedAt: `2026-07-30`
...
- evidence: [Phase 5 计划](2026-07-29-agent-production-capability-rollout.md)；
  [ADR-0064](../../../docs/adr/0064-conservative-skill-effects-and-capability-profile-admission.md)；
...
- evidence: [Phase 1C 计划](2026-07-29-agent-production-runtime-resilience.md)；
  [ADR-0055](../../../docs/adr/0055-cumulative-runtime-resource-governance.md)
- approvedAt: `2026-07-30`
...
- evidence: 本文 Owner 表；[ADR-0060](../../../docs/adr/0060-single-maintainer-release-governance.md)；
  [ADR-0067](../../../docs/adr/0067-single-maintainer-candidate-security-review.md)；
...
[ADR-0066](../../../docs/adr/0066-deepseek-owner-accepted-provider-data-policy.md)、
[ADR-0067](../../../docs/adr/0067-single-maintainer-candidate-security-review.md)。
...
| 4 | 2026-07-30 | Task 0.5 产生 `MS:M0`；完成 Phase 0 并激活 1A.1/1C.1 binding | [Phase 0 完成记录](https://github.com/ferqx/kite-code/blob/8aa02d4ca07350f37d3805c17ac9f10bf828e6a9/docs/space/execution/completed/2026-07-30-agent-production-governance.md)、`4be8735b29ec0fe3951bf7a0876f7b5e722c846a` |
...
| 11 | 2026-07-31 | 完成 1B.1 fail-closed execution boundary；激活 1B.2/1B.3/1B.4 | `3ada4246b149444ce27ed713cd5425090367c1fc`、[完成记录](https://github.com/ferqx/kite-code/blob/8aa02d4ca07350f37d3805c17ac9f10bf828e6a9/docs/space/execution/completed/2026-07-31-agent-production-execution-boundary.md)、独立复核最终 GO 且无剩余 P0/P1/P2 |
| 12 | 2026-08-01 | 完成 1B.4 fail-closed network boundary；激活 1A.6 remote MCP egress | `bc03f77a3dac2962cd3158d3413f292b8388a0d8`、[完成记录](https://github.com/ferqx/kite-code/blob/8aa02d4ca07350f37d3805c17ac9f10bf828e6a9/docs/space/execution/completed/2026-08-01-agent-production-network-boundary.md)、独立复核最终 GO 且无剩余 P0/P1/P2 |
| 13 | 2026-08-01 | 完成 1A.6 remote MCP 独立内容外发门禁；激活 1A.7 文档与迁移收敛 | `545161a7103365038989c6a935a216c5bd5fc7e8`、[完成记录](https://github.com/ferqx/kite-code/blob/8aa02d4ca07350f37d3805c17ac9f10bf828e6a9/docs/space/execution/completed/2026-07-30-agent-production-local-data-privacy.md)、独立复核第五轮最终 GO 且无剩余 P0/P1/P2 |
| 14 | 2026-08-01 | 完成 1A.7 文档与迁移总收敛；唯一产生 `MS:1A-DONE` | `389a0cc45c36e59d961c659ab4df4015a722f7de`、[Required run 30670346726](https://github.com/ferqx/kite-code/actions/runs/30670346726)、[完成记录](https://github.com/ferqx/kite-code/blob/8aa02d4ca07350f37d3805c17ac9f10bf828e6a9/docs/space/execution/completed/2026-07-30-agent-production-local-data-privacy.md)、独立复核最终 GO 且无 P0/P1/P2 |
...
| 17 | 2026-08-01 | 以三平台明确排除负向完成 1B.2/1B.3，并激活 1B.5；保持 D-04 空支持集且不产生 `MS:1B-DONE` | `c9e0dccdaad4cc6a6db57b54d80e0074e3bf8aa4`、[Platform Capability Probe run 30693651821](https://github.com/ferqx/kite-code/actions/runs/30693651821)、[Required run 30693651834](https://github.com/ferqx/kite-code/actions/runs/30693651834) 六个 job 全部通过、[完成记录](https://github.com/ferqx/kite-code/blob/8aa02d4ca07350f37d3805c17ac9f10bf828e6a9/docs/space/execution/completed/2026-08-01-agent-production-platform-exclusions.md)、两路独立复核最终 GO 且无剩余 P0/P1/P2 |
...
| 38 | 2026-08-03 | 采用 implementation-first 批次继续实现 2A–6 本地控制面，不在普通 Task 边界重复 Review/PR/全量 CI，也不提前提升 evidence-bound Task | 新增 RC/GA assembly、Gate replay/schema rollback、Agent task product companion、governed exporter/Runtime bridge、baseline 与 incident retained ledger、Compaction production-owned continuation/route contract 和 authentication lookup、四轨 capability producer/verifier/workflow、maturity/GA/Auto source-owned verifier lookup、capability rollout admission、production-owned MCP write governance/空 route registry 与 sealed production durable dispatch guard；定向测试与 typecheck 通过；54 completed/5 in_progress/49 unbound 和所有 milestone 保持不变，真实 route/participant/incident/SLO/signing/maturity/第三方安全评审 evidence 未伪造 |
...
| 45 | 2026-08-04 | 将 G0/G1 确立为首发路线终态；取消 Limited cohort SLO、长期服务等级/error-budget、dogfood/canary/maturity、Auto Compaction rollout 与 GA observation 后续路线 | 用户直接决策、ADR-0069、`release/oss-first-release/task-status.json`；83 completed、25 superseded、0 optional；原 21 个 optional 均真实标记为 superseded，未伪造外部运营或 promotion 证据 |
