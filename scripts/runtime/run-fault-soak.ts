...
const telemetryPreload = resolve(
  process.cwd(),
  'tests/qualification/runtime/harness/fault-soak-telemetry-preload.ts',
);
...
const PROBES: readonly ProbeDefinition[] = [
  {
    ...
    args: [
      ...
      'apps/kite-cli/test/isolated/runtime/agent.integration.test.ts',
      'apps/kite-cli/test/runtime/context-compaction.test.ts',
  ...
  },
  {
    ...
    args: [
      'test',
      'apps/kite-cli/test/runtime/cancel-resume.test.ts',
      'apps/kite-cli/test/subagent-runner.test.ts',
    ],
    qualificationLifecycleFiles: ['apps/kite-cli/test/runtime/cancel-resume.test.ts'],
    terminalEvidence: {
      cancelled:
  ...
  },
  {
    ...
    args: [
      'test',
      'apps/kite-cli/test/model.test.ts',
      'apps/kite-cli/test/model-invoke.test.ts',
      'apps/kite-cli/test/model-invocation-gateway.test.ts',
      'apps/kite-cli/test/runtime/failure-mode-conformance.test.ts',
    ],
    qualificationLifecycleFiles: ['apps/kite-cli/test/model-invoke.test.ts'],
    terminalEvidence: {
  ...
  },
  {
    ...
    args: [
      ...
      'apps/kite-cli/test/mcp-supervisor.test.ts',
      'apps/kite-cli/test/isolated/runtime/tool-controller.test.ts',
      'apps/kite-cli/test/runtime/failure-mode-conformance.test.ts',
    ],
    qualificationLifecycleFiles: ['apps/kite-cli/test/mcp-supervisor.test.ts'],
    terminalEvidence: {
  ...
  },
  {
    ...
    qualificationLifecycleFiles: ['tests/qualification/runtime/fault-injection.test.ts'],
    terminalEvidence: {
      reconciliation_required:
  ...
  },
  {
    ...
    args: [
      'test',
      'tests/qualification/runtime/fault-injection.test.ts',
      'apps/kite-cli/test/isolated/session-logger/composition.test.ts',
      'apps/kite-cli/test/runtime/failure-mode-conformance.test.ts',
      '-t',
