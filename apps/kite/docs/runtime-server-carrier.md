...
本页是 `apps/kite` 的 owner-local current authority，描述 App 对 Runtime Server 的 composition、stdio 与 development loopback carrier 边界。
...
本地覆盖入口：`apps/kite/test/isolated/runtime-stdio-carrier.test.ts`、`apps/kite/test/isolated/runtime-stdio-child.test.ts`、`apps/kite/test/isolated/development-loopback-carrier.test.ts`、`apps/kite/test/isolated/development-runtime-reference.test.ts`、`apps/kite/test/isolated/runtime-transport-conformance.test.ts`。

运行：`bun test apps/kite/test/isolated/runtime-stdio-carrier.test.ts apps/kite/test/isolated/runtime-stdio-child.test.ts apps/kite/test/isolated/development-loopback-carrier.test.ts apps/kite/test/isolated/development-runtime-reference.test.ts apps/kite/test/isolated/runtime-transport-conformance.test.ts`。
