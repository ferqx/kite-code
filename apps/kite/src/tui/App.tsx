...
import { type LanguagePreference, saveModelSelection } from '#app/config';
...
export interface AppProps {
  ...
  availableModels?: import('#app/config').AvailableModel[];
...
export default function App({
  ...
  const selectModel = useCallback(
    (model: import('#app/config').AvailableModel) => {
