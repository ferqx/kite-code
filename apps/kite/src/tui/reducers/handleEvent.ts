...
/** Internal rendering vocabulary shared by RuntimePresentationEvent rendering paths.
 * RuntimePresentationEvent remains the only streamed action accepted by the TUI reducer. */
...
/** Shared RuntimePresentationEvent rendering path for live updates and session replay. */
