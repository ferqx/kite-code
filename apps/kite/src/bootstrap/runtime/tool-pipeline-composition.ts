...
import {
  ...
  type RuntimeHostState25ToolGovernancePortV1,
...
export interface AppToolPipelineTurnCompositionV1 {
  ...
  readonly governance: RuntimeHostState25ToolGovernancePortV1;
}
...
export function createAppToolPipelineCompositionV1(
  ...
  const forTurn = (
    ...
    const governance = createRuntimeHostState25ToolGovernanceV1({
