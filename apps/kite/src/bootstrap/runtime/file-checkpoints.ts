 ...
 *   在 State25SessionStorageV1 记录目标文件原像（best-effort，失败静默）。
...
import type { State25SessionStorageV1 } from './state25-runtime';
...
export function createFilePreimageRecorder(
  store: State25SessionStorageV1 | undefined,
  threadId: string,
...
type FileRestorePlanItem = ReturnType<State25SessionStorageV1['fileRestorePlan']>[number];
