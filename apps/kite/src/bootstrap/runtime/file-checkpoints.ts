 ...
 *   在 State26SessionStorageV1 记录目标文件原像（best-effort，失败静默）。
...
import type { State26SessionStorageV1 } from './state26-runtime';
...
export function createFilePreimageRecorder(
  store: State26SessionStorageV1 | undefined,
  threadId: string,
...
type FileRestorePlanItem = ReturnType<State26SessionStorageV1['fileRestorePlan']>[number];
