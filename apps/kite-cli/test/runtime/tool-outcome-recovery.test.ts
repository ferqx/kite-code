...
import { runStateRuntimeLoop } from '#kite-cli/bootstrap/runtime/state-runner';
...
import { createProviderReadinessTestHarness } from '../../../../tests/helpers/provider-readiness';
import {
...
describe('ToolOutcome', () => {
  ...
  test('validates the detail-code matrix for every FailureKind and rejects cross-kind detail reuse', () => {
    const kinds = [
      ...
      'unknown',
    ] as const satisfies readonly import('#kite-cli/bootstrap/runtime/failures').FailureKind[];
