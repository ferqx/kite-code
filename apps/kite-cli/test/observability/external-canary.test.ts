...
import { type AgentConfig, EMBEDDED_RELEASE_PROFILES_ } from '#kite-cli/config';
import type { TelemetryConsentGrant } from '#kite-cli/observability/consent';
import { composeExternalCanaryObservability } from '#kite-cli/observability/external-canary';
