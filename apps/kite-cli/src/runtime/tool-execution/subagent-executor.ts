...
} from '#kite-cli/bootstrap/runtime/approval-binding';
import { classifyFailure } from '#kite-cli/bootstrap/runtime/failures';
...
} from '#kite-cli/bootstrap/runtime/subagent/continuation-codec';
import type { TaskToolDeps } from '#kite-cli/bootstrap/runtime/subagent/task-tool';
import type {
  RestoredSubAgentContinuation,
  SubAgentApprovalFacts,
  SubAgentResult,
  SubAgentToolDispatcher,
} from '#kite-cli/bootstrap/runtime/subagent/types';
...
import { visibleProjectInstructions } from '#kite-cli/runtime/tool-execution/project-instruction-guard';
import type {
...
export function blockedSubagentReviewEvent(input: {
  ...
  parentToolCallId: string;
  blocked: NonNullable<
    import('#kite-cli/bootstrap/runtime/subagent/types').SubAgentResult['blocked']
  >;
  availCtx: AppToolTurnContext;
