...
import { type AgentConfig, EMBEDDED_RELEASE_PROFILES_ } from '#kite-service/config';
import type { TelemetryConsentGrant } from '#kite-service/observability/consent';
import { composeExternalCanaryObservability } from '#kite-service/observability/external-canary';
import { resolveReleaseComposition } from '#kite-service/release/composition-root';
