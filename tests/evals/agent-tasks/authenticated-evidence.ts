...
import { releaseArtifactIdentityV1Schema } from '../../../scripts/release/evidence-schema';
import { ADVERSARIAL_CONTRACT_CATALOG_V1 } from './adversarial-contract';
import { D07_APPROVED_POLICY_V1 } from './approved-policy';
...
const adversarialReceiptSchema = z
  .object({
...
const adversarialEvidenceSchema = z
  .object({
    ...
    receipts: z.array(adversarialReceiptSchema),
...
export const authenticatedAgentTaskEvidenceV1Schema = z
  .object({
    ...
    caseLedgers: z.array(caseLedgerSchema),
    adversarial: adversarialEvidenceSchema,
...
export type AgentTaskEvidenceSourceV1 = z.infer<typeof sourceIdentitySchema>;
...
export type AgentTaskCandidateIdentityV1 = z.infer<typeof candidateIdentitySchema>;
export type AgentTaskG0CountsV1 = z.infer<typeof g0CountsSchema>;
export type AgentTaskRetainedAttemptV1 = z.infer<typeof retainedAttemptSchema>;
export type AgentTaskCaseLedgerV1 = z.infer<typeof caseLedgerSchema>;
export type AgentTaskFormalAdversarialReceiptV1 = z.infer<typeof adversarialReceiptSchema>;
export type AgentTaskFormalAdversarialEvidenceV1 = z.infer<typeof adversarialEvidenceSchema>;
...
export function computeAgentTaskSourceDigestV1(
  ...
  return sha256DomainSeparated(
    ...
    canonicalJsonBytes(sourceIdentitySchema.parse(source)),
  );
}
...
export function computeAgentTaskCandidateDigestV1(
  ...
  return sha256DomainSeparated(
    ...
    canonicalJsonBytes(candidateIdentitySchema.parse(candidate)),
  );
}
