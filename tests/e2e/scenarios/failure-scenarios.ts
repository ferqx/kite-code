...
export const operationRetry: Scenario = {
  ...
  steps: [
    ...
    { type: "model-retry", attempt: 1, error: "Connection timeout to remote server", delayMs: 0 },
    { type: "agent-text", text: "Retrying deployment..." },
    { type: "model-retry", attempt: 2, error: "Connection timeout to remote server", delayMs: 0 },
...
export const errorRecovery: Scenario = {
  ...
  steps: [
    ...
    { type: "model-retry", attempt: 1, error: "Config file not found, searching for alternatives", delayMs: 0 },
