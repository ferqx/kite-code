...
const PLAN_SYSTEM_PROMPT = [
  ...
  '',
  '## Rules',
  '- Base your design on the findings and requirements provided in the task. Do NOT explore the codebase beyond what the task provides. If you need to verify a specific file path mentioned in the task, read that file directly — do not search for alternatives.',
...
const CODE_SYSTEM_PROMPT = [
  ...
  '- If a command is blocked because it requires approval, try a different approach: use dedicated read-only tools first, then try a different tool or different arguments. Do not retry the exact same command.',
