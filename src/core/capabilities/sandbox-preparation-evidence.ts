...
import { digestCapability } from './catalog';
...
export function sandboxDisposalLifecycleIntentDigestV1(input: {
  ...
  return digestCapability({ kind: 'sandbox_disposal_lifecycle_intent_v1', ...input });
}
...
export function sandboxAbandonmentLifecycleIntentDigestV1(input: {
  ...
  return digestCapability({ kind: 'sandbox_abandonment_lifecycle_intent_v1', ...input });
}
