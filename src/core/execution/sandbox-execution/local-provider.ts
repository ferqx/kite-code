...
import { generateBwrapArgs } from '@/core/sandbox/bwrap';
import { discoverRuntimeReadOnlyRoots, generateSandboxProfile } from '@/core/sandbox/profile';
import { findApplySeccomp, resolveSeccompPath } from '@/core/sandbox/seccomp';
...
export class LocalSandboxExecutionProviderV1 implements SandboxExecutionProviderV1 {
  ...
  async dispose(input: {
    readonly grant: import('@/protocol/sandbox-execution-provider').SandboxCleanupGrantV1;
