/**
 * ToolSpec Registry — 注册、查找与派生产物（ADR-0026 §1）。
 * ToolSpec Registry — registration, lookup and derived artifacts (ADR-0026 §1).
 *
...
export class ToolRegistry {
   ...
   * 内建工具不参与动态 binding，inputSchema/outputSchema 投影留待迁移需要时补充。
   */
