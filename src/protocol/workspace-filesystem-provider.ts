...
/** Opaque private Artifact identity persisted by Pipeline before mutation_ready. */
...
export interface FilesystemCommitGrantV1 extends WorkspaceFilesystemGrantBaseV1 {
  ...
  readonly mutationReady: import('./capabilities').WorkspaceFilesystemMutationReadyRecordV1;
